...
contextBridge.exposeInMainWorld('stealth', {
  ...
  setA11yMode: (mode) => ipcRenderer.send('set-a11y-mode', mode),
  ...
  setWinOpacity: (hwnd, opacity) => ipcRenderer.invoke('set-win-opacity', hwnd, opacity),
  pickWindow: () => ipcRenderer.invoke('pick-window'),
