...
contextBridge.exposeInMainWorld('stealth', {
  ...
  pickTargetWindow: () => ipcRenderer.invoke('pick-target-window'),
  setTargetOpacity: (value) => ipcRenderer.invoke('set-target-opacity', value),
  resetTargetOpacity: () => ipcRenderer.invoke('reset-target-opacity'),
